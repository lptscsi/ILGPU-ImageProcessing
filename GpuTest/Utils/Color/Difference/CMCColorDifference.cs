using static GpuTest.MathUtils;
...
/// </remarks>
public readonly struct CMCColorDifference : IColorDifference<LAB>
{
    /// <summary>
    /// Chroma.
    /// </summary>
    ...
    public CMCColorDifference(in CMCColorDifferenceThreshold threshold)
        : this(threshold == CMCColorDifferenceThreshold.Acceptability ? 2 : 1, 1)
    {
    }
